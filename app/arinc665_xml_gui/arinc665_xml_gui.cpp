 ...
 *
 * @brief ARINC 665 Media Set XML QT Application.
 **/
...
try
{
  ...
  QApplication::setApplicationName( "ARINC 665 Media Set XML" );
  QApplication::setApplicationDisplayName( "ARINC 665 Media Set XML" );
