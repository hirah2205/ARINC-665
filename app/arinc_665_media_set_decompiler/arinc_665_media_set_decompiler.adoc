...
arinc_665_media_set_decompiler - decompiles ARINC 665 Media Sets and creates an associated XML Configuration file.

== Synopsis

*arinc_665_media_set_decompiler* {-d|--source-directory _Source_}... -f|--xml-file _XML File_ [-i|--check-file-integrity true|false]
