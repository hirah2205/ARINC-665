...
#ifndef ARINC_665_UTILS_FILESYSTEMMEDIASETREMOVER_HPP
#define ARINC_665_UTILS_FILESYSTEMMEDIASETREMOVER_HPP
 ...
 **/
class ARINC_665_EXPORT FilesystemMediaSetRemover
{
  public:
    /**
