...
#ifndef ARINC665_QT_MEDIA_SET_MANAGER_MEDIASETMANAGERSETTINGSDIALOG_HPP
#define ARINC665_QT_MEDIA_SET_MANAGER_MEDIASETMANAGERSETTINGSDIALOG_HPP
 ...
 **/
class ARINC665_QT_EXPORT MediaSetManagerSettingsDialog  final : public QDialog
{
    Q_OBJECT
